<template>
  <div class="bigbox">
    ...
    >
      <tr height="5%">
        <td class="tdTitle tdHead" colspan="6" rowspan="2" width="56%">个人消费分期服务申请表</td>
      ...
      <tr height="5%">
        ...
        <td colspan="4">
          12. 月客户服务费率（%）：
          <span class="underline">{{userData.monthManageFeeRate}}</span>
        </td>
      </tr>
      <tr height="5%">
        <td colspan="3">
          13. 首次应付服务费总额（元）：
          <span class="underline">{{userData.monthManageFee1}}</span>
        </td>
        <td colspan="3">
          14. 首次还款日：
          <br />
      ...
      <tr height="10%">
        <td class="tdTitle" colspan="10">还款账户信息</td>
      </tr>
      <tr height="5%">
        <td colspan="7">
          17. 客户银行账户信息（用于收款、扣款）：户名：
      ...
      <tr height="5%">
        <td
          colspan="10"
        >本人选择银行代扣还款，表明本人同意并授权佰仟融资租赁有限公司委托第三方支付机构有权从本人指定的银行账户（如第17项所示）划扣首次应付服务费总额（如第13项所示）、每月应付服务费总额（如第15项所示）及《个人消费分期服务协议》项下其他应由本人偿还的款项。本人同意该账户同时可用于因提前还款等引起的资金往来。</td>
      </tr>
      <tr height="10%">
      ...
      <tr height="5%">
        <td colspan="10">
          本人具有完全民事行为能力签署本申请表并承担相应责任。本人已仔细阅读并完全了解《个人消费分期服务协议》，并且自愿遵守相关的协议规定。
          <br />本人保证在此表上填写、确认的内容及向佰仟租赁提供的所有相关资料全部真实、有效，如本人提供虚假资料，将承担由此引起的一切责任及损失。本人在此同意佰仟租赁按照相关法律法规的规定，向有权机构报送本人的个人信用信息，包括但不限于本申请表项下的信息，同时，授权佰仟租赁向任何可能的来源查询本人及配偶的与本次申请有关的个人信息和个人信用信息，相关查询结果的用途将用于分期审查和管理。假如本人违反《个人消费分期服务协议》的任何约定（包括但不限于逾期偿还任何款项），本人同意佰仟租赁直接或者经由第三方，通过当面拜访、电话、邮寄、网络等合法形式联系本申请表载明的本人配偶、家庭成员及其他联系人，因此产生的一切责任及后果均由本人自行承担。
          <br />本人同意如因单方面取消申请或不具备借款条件，申请不获批准，本表格及所有已提交的资料无须退还本人，由佰仟租赁处理。佰仟租赁有权拒绝本申请而无须给予任何原因解释。
        </td>
      </tr>
      <tr height="5%">
        <td
    ...
    <fileButton path="/AddressConfirmation" back="/confirmSubmit" index="3"></fileButton>
  </div>
</template>
<script>
import {
